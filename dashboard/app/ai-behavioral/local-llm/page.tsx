...
type MailProposal = { id: string; conversation_id: string; user_name: string; full_name?: string | null; department?: string | null; recipient_email?: string | null; subject: string; body: string; source_template_id?: number | null; source_template_name?: string | null; template_origin?: 'saved' | 'suggested' | 'fallback'; incident_summary_json: string; rationale?: string | null; status: 'pending' | 'sent' | 'rejected' | 'failed' | 'unresolved'; reviewed_by?: string | null; reviewed_at?: string | null; review_decision?: 'approved' | 'rejected' | null; created_at: string; updated_at: string; sent_at?: string | null; error_message?: string | null }
