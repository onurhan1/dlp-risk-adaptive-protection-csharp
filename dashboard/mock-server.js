    ...
    if (pathname === '/api/settings/imap/message' || pathname.match(/^\/api\/settings\/imap\/messages\/[^/]+$/)) {
        ...
        return {
            ...
            body_text: [
                ...
                'Gonderim musteri talebine istinaden yapilmistir. Benzer durumlarda bu yonteme basvurmayacagimi kabul ederim.',
                '',
                'Saygilarimla,',
                'Test Kullanici',
                '',
                'From: Veri Guvenligi Yonetimi <veriguvenligiyonetimi@example.com>',
                'Sent: Friday, July 31, 2026 9:14 AM',
                'To: Test Kullanici <test.kullanici@example.com>',
                'Cc: Veri Guvenligi Yonetimi <veriguvenligiyonetimi@example.com>',
                'Subject: Veri Guvenligi Olay Kaydi Incelemeleri Kapsaminda',
                '',
                'Periyodik kontroller kapsaminda hassas veri gonderimi tespit edilmistir. Islemi aciklamanizi rica ederiz.',
            ].join('\n'),
            truncated: false,
            tested_at: new Date().toISOString(),
        }
