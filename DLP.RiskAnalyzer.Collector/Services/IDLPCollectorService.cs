...
public interface IDLPCollectorService
{
    ...
    Task PushReleasedIncidentToRedisStreamAsync(int incidentId, string incidentTime, string action, string taskName, string? adminName, string? comments, string? updateTime);
}
